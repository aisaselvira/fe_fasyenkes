...
import {mapToTPPRJCase} from "@/services/simulation/index";
...
export function TPPRJCaseList({searchQuery = ""}: TPPRJCaseListProps) {
    ...
    if (error) {
        return <ErrorState message="Halaman tidak bisa dimuat" onRetry={fetchCases} />;
    }
