            ...
            <div className="p-3 sm:p-4">
                ...
                <div className="grid gap-3 sm:gap-4">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-[150px_1fr] items-start gap-1 sm:gap-2">
                        ...
                        <RadioGroup defaultValue="PEREMPUAN" className="flex flex-wrap gap-2 sm:gap-4">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-[150px_1fr] items-start gap-1 sm:gap-2">
                        ...
                        <RadioGroup defaultValue="WNI" className="flex gap-4">
                            <div className="flex items-center space-x-2">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-[150px_1fr] items-start gap-1 sm:gap-2">
                        ...
                        <div className="grid grid-cols-1 xs:grid-cols-2 md:grid-cols-3 gap-1 sm:gap-2">
                            <RadioGroup name="pendidikan" defaultValue="TIDAK SEKOLAH" className="space-y-1 sm:space-y-2">
                                <div className="flex items-center space-x-2">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-[150px_1fr] items-start gap-1 sm:gap-2">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-3 gap-1 sm:gap-2">
                            <RadioGroup name="golongan-darah" defaultValue="A" className="flex flex-wrap gap-3">
                                <div className="flex items-center space-x-2">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-[150px_1fr] items-start gap-1 sm:gap-2">
                        ...
                        <div className="grid grid-cols-1 xs:grid-cols-2 md:grid-cols-3 gap-1 sm:gap-2">
                            <RadioGroup name="agama" defaultValue="ISLAM" className="space-y-1 sm:space-y-2">
                                <div className="flex items-center space-x-2">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-[150px_1fr] items-start gap-1 sm:gap-2">
                        ...
                        <div className="grid grid-cols-1 xs:grid-cols-2 md:grid-cols-3 gap-1 sm:gap-2">
                            <RadioGroup name="status-perkawinan" defaultValue="BELUM KAWIN" className="space-y-1 sm:space-y-2">
                                <div className="flex items-center space-x-2">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-[150px_1fr] items-start gap-1 sm:gap-2">
                        ...
                        <div className="grid grid-cols-1 xs:grid-cols-2 md:grid-cols-3 gap-1 sm:gap-2">
                            <RadioGroup name="pekerjaan" defaultValue="TIDAK BEKERJA" className="space-y-1 sm:space-y-2">
                                <div className="flex items-center space-x-2">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-[150px_1fr] items-start gap-1 sm:gap-2">
                        ...
                        <div className="grid grid-cols-1 xs:grid-cols-2 md:grid-cols-3 gap-1 sm:gap-2">
                            <RadioGroup name="hambatan" defaultValue="TIDAK ADA" className="space-y-1 sm:space-y-2">
                                <div className="flex items-center space-x-2">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-[150px_1fr] items-start gap-1 sm:gap-2">
                        ...
                        <div className="grid grid-cols-1 xs:grid-cols-2 md:grid-cols-3 gap-1 sm:gap-2">
                            <RadioGroup name="cara-pembayaran" defaultValue="JKN" className="space-y-1 sm:space-y-2">
                                <div className="flex items-center space-x-2">
                ...
                <div className="mt-6 sm:mt-8">
                    ...
                    <div className="bg-gray-50 p-3 sm:p-4 rounded-md">
                        <div className="grid gap-2">
                            <div className="flex items-start space-x-2">
                                <Checkbox id="privacy-1" defaultChecked />
                ...
                <div className="mt-6 sm:mt-8 flex flex-col sm:flex-row justify-between gap-3">
                    <Button variant="outline" className="order-2 sm:order-1">
                        <span className="mr-2">×</span> Batal
                    </Button>
                    <Button className="bg-[#2E3192] hover:bg-[#252880] text-white order-1 sm:order-2">Simpan</Button>
                </div>
            </div>
        </div>
    )
