        ...
        <div className="w-full max-w-4xl mx-auto mt-10">
            ...
            <div className="w-full max-w-4xl mx-auto bg-white rounded-[20px] border border-gray-200 shadow-sm overflow-hidden mt-10 p-10">
                <div className="space-y-6">
                    <DetailRow label="Jenis Kunjungan" value={formatLabel(data.category)} />
                    <DetailRow label="Jenis Pasien" value={formatLabel(data.patient_type)} />
                    <DetailRow label="Keluhan" value={data.diagnose} />
